            ...
            <section className="bighero-row">
                <div className="home-bighero-container">
                    <div className="bighero-text">
                        ...
                        <h3 className="bighero-subtitle">30 giorni, 30 foche e 30 movimenti artistici diversi per dare spazio alla creatività! Scorri per scoprire l'elenco dei prompt e per trovare l'ispirazione con le schede dedicate a ciascun movimento artistico</h3>
            ...
            <section className="about-row">
                <div className="about-text-column">
                    ...
                    <p className="about-text">
                        ...
                        <br/><br/>
                        Esplorate l'elenco dei prompt per questa edizione del Sealtember che trovate qui sotto e date sfogo alla fantasia, se prendete parte alla challenge e volete pubblicare i vostri disegni sui profili social ricordatevi di usare l'hashtag #Sealtember2024!
                    </p>
                </div>
            </section>
            ...
            <section className="prompt-row" ref={promptRef}>
                <div className='prompt-col'>
                    ...
                    <div className='prompt-title-wrapper'>
                        <h2 className='prompt-title'>Elenco dei Prompt</h2>
                        <p className='prompt-subtitle'>Qui sono elencati i 30 prompt per questa edizione del sealtember, cliccando su ciascun prompt potrai vedere una scheda dedicata al movimento artistico per scoprirne di più e trovare ispirazione</p>
                    </div>
